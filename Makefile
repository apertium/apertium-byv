...
pkgdatadir = $(datadir)/apertium-byv
pkgincludedir = $(includedir)/apertium-byv
pkglibdir = $(libdir)/apertium-byv
pkglibexecdir = $(libexecdir)/apertium-byv
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/apertium-byv.pc.in COPYING install-sh missing
...
CONFIG_CLEAN_FILES = apertium-byv.pc
...
am__installdirs = "$(DESTDIR)$(apertium_byvdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_byv_DATA) $(noinst_DATA) $(pkgconfig_DATA)
...
ACLOCAL = ${SHELL} /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/usr/include/apertium-3.4 -I/usr/lib/i386-linux-gnu/apertium-3.4/include -I/usr/include/lttoolbox-3.3 -I/usr/lib/i386-linux-gnu/lttoolbox-3.3/include -I/usr/include/libxml2  
APERTIUM_LIBS = -lapertium3 -llttoolbox3 -lxml2 -lpcre  
AUTOCONF = ${SHELL} /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv/missing autoconf
AUTOHEADER = ${SHELL} /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv/missing autoheader
AUTOMAKE = ${SHELL} /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv/missing automake-1.14
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Medumba\" -DPACKAGE_TARNAME=\"apertium-byv\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Medumba\ 0.1.0\" -DPACKAGE_BUGREPORT=\"yopasylvestre@gmail.com\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-byv\" -DPACKAGE=\"apertium-byv\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-byv
PACKAGE_BUGREPORT = yopasylvestre@gmail.com
PACKAGE_NAME = Apertium Medumba
PACKAGE_STRING = Apertium Medumba 0.1.0
PACKAGE_TARNAME = apertium-byv
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-byv
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv
abs_srcdir = /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv
abs_top_builddir = /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv
abs_top_srcdir = /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv
am__leading_dot = .
...
install_sh = ${SHELL} /home/mathematic-alpha/Desktop/bootstrap-master/apertium-byv/install-sh
...
###############################################################################
#
#   apertium_byv_dir: This is where the compiled binaries go
#   apertium_byv_srcdir: This is where the source files go
apertium_byvdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_byv_srcdir = $(prefix)/share/apertium/$(BASENAME)/
EXTRA_TARGETS = $(am__append_1)
apertium_byv_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS) $(LANG1).prob
...
$(am__aclocal_m4_deps):
apertium-byv.pc: $(top_builddir)/config.status $(srcdir)/apertium-byv.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_byvDATA: $(apertium_byv_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_byv_DATA)'; test -n "$(apertium_byvdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_byvdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_byvdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_byvdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_byvdir)" || exit $$?; \
	done

uninstall-apertium_byvDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_byv_DATA)'; test -n "$(apertium_byvdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_byvdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_byvdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_byvDATA install-data-local \
...
uninstall-am: uninstall-apertium_byvDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_byvDATA install-data \
	...
	uninstall-am uninstall-apertium_byvDATA \
	uninstall-pkgconfigDATA
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_byv_srcdir) || mkdir -p $(DESTDIR)$(apertium_byv_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_byv_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_byv_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_byv_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_byv_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . byv-morph | tee .test-mt
